...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "te1eeab8cetb5mc357e4egn.deviceadvisor.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "K510-CRB-KIT" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "K510-CRB-KIT" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "AmazonRootCA1.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "K510-CRB-KIT-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "K510-CRB-KIT-private.pem.key" ///< Device private key filename
// =================================================
